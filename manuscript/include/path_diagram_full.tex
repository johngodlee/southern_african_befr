...
\node [observed] (sc) [left = 0.5in of somid] {SOC};
\node [observed] (ss) at (somid) {Sand};
...
\draw [loading] (m) to node[left, pos=0.5] {\pcfmmp{}} (mp);
