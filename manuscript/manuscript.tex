...
\begin{figure}[H]
	...
	\caption{The locations of the \nplots{} plots used in this study, as points by geographic location with respect to the distribution of Miombo woodland vegetation according to \citet{White1987}. Points are coloured according to their vegetation type as defined by the vegetation types in \autoref{clust_summ}.}
\end{figure}
