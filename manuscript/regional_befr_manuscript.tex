...
\textbf{Methods:} We used a network of \nplots{} \rchange{savanna and woodland}{savanna/woodland tree} plots located across the southern African sub-continent \rold{in which each tree >10 cm diameter was measured and identified to species level}. We used Structural Equation Modelling and path analysis to determine the relationship between tree species diversity and aboveground woody biomass, while accounting for the interactive effects of resource availability \rnew{, disturbance by fire}, and stem density.
