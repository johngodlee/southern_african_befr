\begin{tikzpicture}[auto,scale=2, 
	...
	corr/.style={<->, thick, bend left=15, dotted, >=stealth'},
...
\node [observed] (mpc) [left = 0.1in of momid] {PS};
\node [observed] (mt) [right = 0.1in of momid] {MAT};
\node [observed] (mtc) [right = 0.8in of momid] {TS};
...
\draw [corr] (d) to node[above=0.05in, pos=0.5] {\pcfdi{}} (i);
